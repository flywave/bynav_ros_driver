...
bynav_gps_msgs::GnssEphemMsg ephem2msg(const EphemPtr &ephem_ptr) {
  bynav_gps_msgs::GnssEphemMsg ephem_msg;
  uint32_t week = 0;
  double tow = 0.0;
...
bynav_gps_msgs::GnssGloEphemMsg
glo_ephem2msg(const GloEphemPtr &glo_ephem_ptr) {
  bynav_gps_msgs::GnssGloEphemMsg glo_ephem_msg;
  uint32_t week = 0;
  double tow = 0.0;
...
bynav_gps_msgs::GnssMeasMsg meas2msg(const std::vector<ObsPtr> &meas) {
  bynav_gps_msgs::GnssMeasMsg gnss_meas_msg;
  for (ObsPtr obs : meas) {
    bynav_gps_msgs::GnssObsMsg obs_msg;
    uint32_t week = 0;
...
msg2meas(const bynav_gps_msgs::GnssMeasMsgConstPtr &gnss_meas_msg) {
  ...
  for (size_t i = 0; i < gnss_meas_msg->meas.size(); ++i) {
    bynav_gps_msgs::GnssObsMsg obs_msg = gnss_meas_msg->meas[i];
    ObsPtr obs(new Obs());
