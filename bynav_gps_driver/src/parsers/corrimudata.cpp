...
const std::string bynav_gps_driver::CorrImuDataParser::MESSAGE_NAME =
    "CORRIMUDATA";

uint32_t bynav_gps_driver::CorrImuDataParser::GetMessageId() const {
  return MESSAGE_ID;
}

const std::string bynav_gps_driver::CorrImuDataParser::GetMessageName() const {
  return MESSAGE_NAME;
}
