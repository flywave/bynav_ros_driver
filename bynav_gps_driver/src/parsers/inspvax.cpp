...
const std::string bynav_gps_driver::InspvaxParser::MESSAGE_NAME = "INSPVAX";

uint32_t bynav_gps_driver::InspvaxParser::GetMessageId() const {
  return MESSAGE_ID;
}

const std::string bynav_gps_driver::InspvaxParser::GetMessageName() const {
  return MESSAGE_NAME;
}
...
bynav_gps_msgs::InspvaxPtr bynav_gps_driver::InspvaxParser::ParseBinary(
  ...
  bynav_gps_msgs::InspvaxPtr ros_msg =
